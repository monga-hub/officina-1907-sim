...
export const BORSA_FABBRICHE_DEFAULT = {
  ...
  chooseProduction: false,                       // true: a inizio turno il giocatore SCEGLIE 1 risorsa (tra i colori adiacenti alle sue fabbriche), gratis, una/turno
  ...
  resourceCap: { enabled: false, base: 10, perFactory: [1, 1, 2], aiValueWaste: true }, // tetto risorse in mano/giocatore = base + Σ incrementi per fabbrica posseduta (indice = n-esima fabbrica; oltre = ultimo). OFF = illimitato (attuale). aiValueWaste: l'IA penalizza le risorse scartate dal tetto (default ON; OFF = ignora lo scarto, per A/B)
